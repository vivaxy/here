...
module.exports = {
    ...
    reloadInterval: getArgumentAfterString(config.watch.key, config.watch.value),
    log: isArgumentExists(config.log.key),
    version: isArgumentExists(config.version.key)
};
