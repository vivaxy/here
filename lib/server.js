 ...
 * @returns {Server}
 */
Server.prototype._initialize = function () {
    var _this = this;
 ...
 * @returns {Server}
 */
Server.prototype._response = function (req, res) {
    var _this = this,
 ...
 * @returns {Server}
 */
Server.prototype._startup = function () {
    var _this = this;
 ...
 * @returns {Server}
 */
Server.prototype._processError = function (res, err) {
    // error occurs
    res.writeHead(404);
 ...
 * @returns {Server}
 */
Server.prototype._redirect = function (res, to) {
    res.writeHead(302, {
        'Location': to
    });
    res.end();
 ...
 * @returns {Server}
 */
Server.prototype._respondFolder = function (res, path, files) {
    res.writeHead(200);
 ...
 * @returns {Server}
 */
Server.prototype._respondFile = function (res, path, contentType, data) {
    res.writeHead(200, {
 ...
 * @returns {string}
 */
Server.prototype._addReloadScript = function (data) {
    var resp = '';
...
Server.prototype.openBrowser = function () {
    // always use current ip address
    var openUrl = 'http://' + ip.address() + ':' + this.port + '/',
        execCommand = process.platform === 'darwin' ?
